...
Use the most human-readable form of the data and output in using Markdown formatting. And display tables along with the summary text whenever there are multiple results.
